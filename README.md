...
- Title Screen: มีปุ่มเริ่มเกมเข้า World Screen, ออกเกม และเปิด/ปิดเพลง
...
## การควบคุม:
### World Screen
- W/A/S/D: เดิน ขึ้น/ซ้าย/ลง/ขวา
- ปุ่ม Stats: ดูสเตตัสตัวละคร
- ปุ่ม Backpack: ดูไอเทม
- ปุ่ม Save: เซฟเกม
- ปุ่ม Exit: กลับไปหน้า Title Screen
### Battle Screen
- ปุ่มสกิล 4 สกิล: ใช้สกิล
- ปุ่ม Backpack: ดูไอเทมและใช้งานไอเทม
- ปุ่ม Run: หนีจากการต่อสู้กลับไปหน้า World Screen